        ...
        return appointmentRepository.findById(id).map(appointment -> {
            ...
            emailService.sendEmail(
                    ...
                    "Dear " + appointment.getPatient().getName() +
                            ...
                            " on " + appointment.getAppointmentTime() + " has been successfully canceled." +
                            "\n\nRegards,\nHospital Team"
            );
            emailService.sendEmail(
                    appointment.getDoctor().getEmail(),
                    "Appointment Canceled",
                    "Dear Dr. " + appointment.getDoctor().getName() +
                            ",\n\nThe appointment with patient " + appointment.getPatient().getName() +
                            " on " + appointment.getAppointmentTime() + " has been canceled." +
                            "\n\nRegards,\nHospital Team"
            );
            return true;
        }).orElse(false);
